			...
			{loading ? (
				...
				<div className="space-y-4">
					{achievementsData.map((achievement, index) => (
						<div
							key={index}
							className="flex flex-col-reverse sm:flex-row items-start gap-4 p-4 rounded-lg border border-border/50 hover:border-blue-700/40 hover:bg-muted/30 transition-all duration-200 group"
						>
